    ...
    data: [
      {
        ...
        location: "header",
        items: [
          { id: crypto.randomUUID(), type: "mega_menu", label: "Men", url: "/categories/men", link: "/categories/men", target: "_self", isVisible: true, isHighlighted: false,
            megaMenuColumns: [
              { id: crypto.randomUUID(), title: "Clothing", items: [
              ...
              { id: crypto.randomUUID(), title: "Featured", items: [
          ...
          { id: crypto.randomUUID(), type: "mega_menu", label: "Women", url: "/categories/women", link: "/categories/women", target: "_self", isVisible: true, isHighlighted: false,
            megaMenuColumns: [
              { id: crypto.randomUUID(), title: "Clothing", items: [
          ...
          { id: crypto.randomUUID(), type: "link", label: "Accessories", url: "/categories/accessories", link: "/categories/accessories", target: "_self", isVisible: true, isHighlighted: false },
      ...
      },
      {
        ...
        location: "footer",
        items: [
          { id: crypto.randomUUID(), type: "link", label: "Men", url: "/categories/men", link: "/categories/men", target: "_self", isVisible: true, isHighlighted: false },
          { id: crypto.randomUUID(), type: "link", label: "Women", url: "/categories/women", link: "/categories/women", target: "_self", isVisible: true, isHighlighted: false },
          { id: crypto.randomUUID(), type: "link", label: "Accessories", url: "/categories/accessories", link: "/categories/accessories", target: "_self", isVisible: true, isHighlighted: false },
          { id: crypto.randomUUID(), type: "link", label: "Collections", url: "/products", link: "/products", target: "_self", isVisible: true, isHighlighted: false },
  ...
  await prisma.footerSection.createMany({
    data: [
      { column: 1, title: "নবME", contentType: "text", content: { text: "Premium fashion destination celebrating the intersection of traditional craftsmanship and contemporary design." }, sortOrder: 1 },
      {
        ...
        content: {
          links: [
            { id: crypto.randomUUID(), label: "Men", url: "/categories/men" },
            { id: crypto.randomUUID(), label: "Women", url: "/categories/women" },
            { id: crypto.randomUUID(), label: "Accessories", url: "/categories/accessories" },
