...
/**
 * AdminLayout — desktop sidebar + mobile drawer. All admin pages render
 * inside this shell; routing lives in app/routes.tsx.
 */
    ...
    <div className="flex min-h-dvh bg-(--bg-page) text-(--text-primary)">
      ...
      >
        <div className="mb-6 flex items-center justify-between">
          <span className="font-display text-lg font-semibold">নবME Admin</span>
          <button
            type="button"
            onClick={closeMobileNav}
