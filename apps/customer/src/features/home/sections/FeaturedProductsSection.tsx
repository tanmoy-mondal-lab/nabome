/**
 * FeaturedProductsSection — displays featured products (HOMEPAGE_BUILDER_ARCHITECTURE §6.2)
 * Shows products in a grid or carousel layout with responsive design.
 * Mobile-first with accessibility and performance optimizations.
 */
...
type FeaturedProductsSectionProps = SectionProps<ProductSectionConfig>;
        ...
        {layout === 'carousel' && (
          <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide sm:grid sm:grid-cols-2 lg:grid-cols-4">
            {displayProducts.map((product) => (
              ...
              >
                <ProductCard product={product} sectionType="featured" />
              </div>
            ))}
          </div>
        )}
