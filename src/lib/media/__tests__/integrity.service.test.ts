...
// Mock Prisma client - using plural model names as generated by Prisma
const mockPrisma = {
  media_assets: {
    findMany: vi.fn(),
    findUnique: vi.fn(),
...
describe("MediaIntegrityService", () => {
  ...
  describe("performFullScan", () => {
    it("should perform a full integrity scan", async () => {
      ...
      (mockPrisma.media_assets.findMany as any).mockResolvedValue([
        {
          id: "1",
          assetId: "AST_123",
          entityType: "products",
      ...
      (mockPrisma.products.findUnique as any).mockResolvedValue({ id: "prod-1" });
    ...
    it("should detect invalid entity references", async () => {
      ...
      (mockPrisma.products.findUnique as any).mockResolvedValue(null);
  ...
  describe("performRepairs", () => {
    it("should delete orphaned database records", async () => {
      ...
      (mockPrisma.media_assets.delete as any).mockResolvedValue({});
