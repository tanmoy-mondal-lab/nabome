import { api as internalApi } from "./client";
...
export const adminApi = {
  ...
  createProduct: (data: unknown) => api.post<Record<string, unknown>>("/admin/products", data),
  updateProduct: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/products/${id}`, data),
  ...
  addProductImage: (id: string, data: { url: string; publicId?: string; altText?: string; isPrimary?: boolean; sortOrder?: number; variantId?: string; type?: string }) =>
    api.post<Record<string, unknown>>(`/admin/products/${id}/images`, data),
  deleteProductImage: (productId: string, imageId: string) =>
    api.delete(`/admin/products/${productId}/images/${imageId}`),

  // Categories
  getCategories: () => api.get<{ categories: unknown[] }>("/admin/categories"),
  createCategory: (data: unknown) => api.post<Record<string, unknown>>("/admin/categories", data),
  updateCategory: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/categories/${id}`, data),
  ...
  createCollection: (data: unknown) => api.post<Record<string, unknown>>("/admin/collections", data),
  updateCollection: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/collections/${id}`, data),
  ...
  updateOrderStatus: (id: string, data: { status: string; note?: string }) =>
    api.put<Record<string, unknown>>(`/admin/orders/${id}/status`, data),
  // Customers
  ...
  createPage: (data: unknown) => api.post<Record<string, unknown>>("/admin/cms/pages", data),
  updatePage: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/cms/pages/${id}`, data),
  ...
  createHomeSection: (data: unknown) => api.post<Record<string, unknown>>("/admin/cms/homepage", data),
  updateHomeSection: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/cms/homepage/${id}`, data),
  ...
  createNavigation: (data: unknown) => api.post<Record<string, unknown>>("/admin/cms/navigation", data),
  updateNavigation: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/cms/navigation/${id}`, data),
  ...
  createFooterSection: (data: unknown) => api.post<Record<string, unknown>>("/admin/cms/footer", data),
  updateFooterSection: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/cms/footer/${id}`, data),
  ...
  createAnnouncement: (data: unknown) => api.post<Record<string, unknown>>("/admin/cms/announcements", data),
  updateAnnouncement: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/cms/announcements/${id}`, data),
  ...
  createCoupon: (data: unknown) => api.post<Record<string, unknown>>("/admin/coupons", data),
  updateCoupon: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/coupons/${id}`, data),
  ...
  approveReview: (id: string, approved: boolean) =>
    api.put<Record<string, unknown>>(`/admin/reviews/${id}/approve`, { approved }),
  deleteReview: (id: string) =>
    api.delete<{ message: string }>(`/admin/reviews/${id}`),

  // Analytics
  getSalesAnalytics: (params?: Record<string, string | undefined>) =>
    api.get<Record<string, unknown>>("/admin/analytics/sales", { params }),
  getProductAnalytics: () => api.get<Record<string, unknown>>("/admin/analytics/products"),
  getCustomerAnalytics: () => api.get<Record<string, unknown>>("/admin/analytics/customers"),
  getDeliveryAddressAnalytics: (params?: Record<string, string | undefined>) =>
    api.get<Record<string, unknown>>("/admin/analytics/delivery-addresses", { params }),

  // Settings
  getSettings: () => api.get<{ settings: unknown }>("/admin/settings"),
  updateSettings: (data: unknown) => api.put<Record<string, unknown>>("/admin/settings", data),

  // Social Links
  getSocialLinks: () => api.get<{ links: unknown[] }>("/admin/social-links"),
  createSocialLink: (data: unknown) => api.post<Record<string, unknown>>("/admin/social-links", data),
  updateSocialLink: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/social-links/${id}`, data),
  ...
  markContactRead: (id: string) => api.put<Record<string, unknown>>(`/admin/contact-submissions/${id}/read`),
  ...
  createTemplate: (data: unknown) => api.post<Record<string, unknown>>("/admin/templates", data),
  updateTemplate: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/templates/${id}`, data),
  ...
  exportProducts: (format: "csv" | "json" = "csv", categoryId?: string) => {
    ...
    return api.get<Record<string, unknown>>(`/admin/products/export?${params}`);
  },
  ...
  createLookbook: (data: unknown) => api.post<Record<string, unknown>>("/admin/lookbooks", data),
  updateLookbook: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/lookbooks/${id}`, data),
  deleteLookbook: (id: string) => api.delete<{ message: string }>(`/admin/lookbooks/${id}`),
  addLookbookItem: (lookbookId: string, data: unknown) =>
    api.post<Record<string, unknown>>(`/admin/lookbooks/${lookbookId}/items`, data),
  ...
  updateLookbookItem: (lookbookId: string, itemId: string, data: unknown) =>
    api.put<Record<string, unknown>>(`/admin/lookbooks/${lookbookId}/items/${itemId}`, data),
  ...
  createBrand: (data: unknown) => api.post<Record<string, unknown>>("/admin/brands", data),
  updateBrand: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/brands/${id}`, data),
  ...
  createSizeGuide: (data: unknown) => api.post<Record<string, unknown>>("/admin/size-guides", data),
  updateSizeGuide: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/size-guides/${id}`, data),
  ...
  createSubcategory: (data: unknown) => api.post<Record<string, unknown>>("/admin/subcategories", data),
  updateSubcategory: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/subcategories/${id}`, data),
  ...
  createLabel: (data: unknown) => api.post<Record<string, unknown>>("/admin/product-labels", data),
  updateLabel: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/product-labels/${id}`, data),
  deleteLabel: (id: string) => api.delete<{ message: string }>(`/admin/product-labels/${id}`),

  // Tags
  getTags: () => api.get<{ tags: unknown[] }>("/admin/product-tags"),
  createTag: (data: unknown) => api.post<Record<string, unknown>>("/admin/product-tags", data),
  updateTag: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/product-tags/${id}`, data),
  ...
  addRelatedProduct: (data: { sourceId: string; targetId: string; type?: string }) =>
    api.post<Record<string, unknown>>("/admin/related-products", data),
  ...
  adjustVariantStock: (variantId: string, data: { quantityChange: number; reason: string; note?: string }) =>
    api.post<Record<string, unknown>>(`/admin/inventory/variant/${variantId}/adjust`, data),
  ...
  resolveAlert: (alertId: string) =>
    api.put<Record<string, unknown>>(`/admin/inventory/alerts/${alertId}/resolve`),
  ...
  scheduleProduct: (id: string, data: { publishAt?: string; archiveAt?: string }) =>
    api.put<Record<string, unknown>>(`/admin/products/${id}/schedule`, data),
  ...
  approveReturn: (id: string, data?: { adminNote?: string }) =>
    api.put<Record<string, unknown>>(`/admin/returns/${id}/approve`, data ?? {}),
  rejectReturn: (id: string, data: { adminNote: string }) =>
    api.put<Record<string, unknown>>(`/admin/returns/${id}/reject`, data),
  receiveReturn: (id: string) => api.put<Record<string, unknown>>(`/admin/returns/${id}/receive`),
  ...
  createRefund: (data: { orderId: string; returnRequestId?: string; amount: number; type: string; notes?: string }) =>
    api.post<Record<string, unknown>>("/admin/refunds", data),
  processRefund: (id: string) => api.post<Record<string, unknown>>(`/admin/refunds/${id}/process`),
  completeRefund: (id: string) => api.post<Record<string, unknown>>(`/admin/refunds/${id}/complete`),
  failRefund: (id: string, data?: { notes?: string }) =>
    api.post<Record<string, unknown>>(`/admin/refunds/${id}/fail`, data ?? {}),
  ...
  updateNotificationTemplate: (id: string, data: unknown) =>
    api.put<Record<string, unknown>>(`/admin/notification-templates/${id}`, data),
  sendManualNotification: (data: { profileId: string; type: string; title: string; body?: string }) =>
    api.post<Record<string, unknown>>("/admin/notifications/send", data),
  ...
  updateSupportTicketStatus: (id: string, data: { status: string }) =>
    api.put<Record<string, unknown>>(`/admin/support/${id}/status`, data),
  assignSupportTicket: (id: string, data: { assignedTo: string }) =>
    api.put<Record<string, unknown>>(`/admin/support/${id}/assign`, data),
  replySupportTicket: (id: string, data: { message: string }) =>
    api.post<Record<string, unknown>>(`/admin/support/${id}/reply`, data),

  // FAQ
  getFaqs: () => api.get<{ faqs: unknown[] }>("/admin/faq"),
  createFaq: (data: { question: string; answer: string; category?: string; sortOrder?: number }) =>
    api.post<Record<string, unknown>>("/admin/faq", data),
  updateFaq: (id: string, data: unknown) => api.put<Record<string, unknown>>(`/admin/faq/${id}`, data),
  ...
  reprocessWebhookEvent: (id: string) =>
    api.post<Record<string, unknown>>(`/admin/webhooks/reprocess/${id}`),
  reconcileWebhookOrder: (orderId: string) =>
    api.post<Record<string, unknown>>(`/admin/webhooks/reconcile/${orderId}`),
  ...
  getWishlists: (params?: Record<string, string | number | undefined>) =>
    api.get<Record<string, unknown>>("/admin/wishlists", { params }),
  ...
  getLoginAttempts: (params?: Record<string, string | number | undefined>) =>
    api.get<Record<string, unknown>>("/admin/login-attempts", { params }),
};
