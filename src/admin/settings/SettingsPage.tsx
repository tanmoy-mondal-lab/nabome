...
function buildSettings(raw: Record<string, unknown>, fallback: Settings): Settings {
  return {
    ...
    logoUrl: (raw.logoUrl as string) ?? fallback.logoUrl,
    logoPublicId: (raw.logoPublicId as string) ?? fallback.logoPublicId,
    faviconUrl: (raw.faviconUrl as string) ?? fallback.faviconUrl,
    faviconPublicId: (raw.faviconPublicId as string) ?? fallback.faviconPublicId,
    ...
    address: (raw.address as string) ?? fallback.address,
