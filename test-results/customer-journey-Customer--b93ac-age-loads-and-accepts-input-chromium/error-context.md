...
- Name: customer-journey.spec.ts >> Customer Journey - Search Flow >> search page loads and accepts input
- Location: e2e/customer-journey.spec.ts:125:3
...
Locator: locator('input[type="search"], input[placeholder*="search" i], input[name="q"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[type="search"], input[placeholder*="search" i], input[name="q"]').first()
...
- main:
  ...
  - paragraph: Enter a search term to find products
- contentinfo:
